...
class SearchFlight:
    ...
    def choose_date(self, trip_type: TripType):
        ...
        current_day_date = int(self.get_current_date(trip_type).split()[0]) if trip_type == TripType.RETURN else -1
        self.choose_certain_date(current_day_date)
    ...
    def change_date(self, trip_type: TripType, negative_test: bool = False):
